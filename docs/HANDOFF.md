...
- **테마 품질 개선 phase 9(2026-07-18, 브랜치 `feat-9-theme-quality`, main 미병합 — feat-8 위에 쌓임)** — 사용자
...
- **배경 테마 시스템 추가(2026-07-18, 브랜치 `feat-8-background-themes`, main 미병합)** — 배경(아쿠아스케이프)을
...
- **main = `v0.8.0`** — 사용자 관점 라이브 QA 평가에서 나온 개선 13건 반영(`fix-7-eval-feedback` 병합).
